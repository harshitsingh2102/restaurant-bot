...
export declare type AnalyzeConversationTaskUnion = AnalyzeConversationTask | ConversationalTask;
export declare type AnalyzeConversationTaskResultUnion = AnalyzeConversationTaskResult | ConversationalTaskResult;
export declare type ConversationUnion = Conversation | TextConversation | TranscriptConversation;
export declare type AnalysisParametersUnion = AnalysisParameters | LuisParameters | ConversationParameters | QuestionAnsweringParameters;
export declare type BasePredictionUnion = BasePrediction | ConversationPrediction | OrchestrationPrediction;
...
export declare type BaseExtraInformationUnion = BaseExtraInformation | EntitySubtype | ListKey;
export declare type TargetIntentResultUnion = TargetIntentResult | NoneLinkedTargetIntentResult | ConversationTargetIntentResult | LuisTargetIntentResult | QuestionAnsweringTargetIntentResult;
export declare type AnalyzeConversationLROTaskUnion = AnalyzeConversationLROTask | AnalyzeConversationPIITask | AnalyzeConversationSummarizationTask;
export declare type AnalyzeConversationJobResultUnion = AnalyzeConversationJobResult | AnalyzeConversationPIIResult | AnalyzeConversationSummarizationResult;
 ...
 * **ConversationalSummarizationResults**
 */
export declare type AnalyzeConversationResultsKind = string;
